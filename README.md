...
directory, and modify the command below as appropriate:
    ...
    curl --silent --location --output /usr/local/bin/differ https://github.com/kevinburke/differ/releases/download/v1.4.0/differ-linux-amd64 && chmod 755 /usr/local/bin/differ
...
If you have a Go development environment, you can also install via source code:
    ...
    go install github.com/kevinburke/differ@v1.4.0
